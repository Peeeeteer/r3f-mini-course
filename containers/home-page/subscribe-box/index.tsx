...
const SubscribeBox: FC<SubscribeBoxProps> = ({ }) => {
  ...
  //           Im coding almost daily and I will be adding new projects here
  //         </p>
  //         <p className="text-white56 text-sm">
  ...
  //           className="text-sm leading-[23px] text-white font-bold py-[7px] px-[31px] rounded-[13px] bg-[#FF3939] border-none outline-none cursor-pointer absolute right-0 top-0"
  //         >
  //           Notify me
  //         </button>
  //       </div>
